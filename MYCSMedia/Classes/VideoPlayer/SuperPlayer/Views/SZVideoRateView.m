...
@implementation SZVideoRateView
{
...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    [speedBtn1 setTitleColor:SZPLAYER_TintColor forState:UIControlStateSelected];
    ...
    [speedBtn2 setTitleColor:SZPLAYER_TintColor forState:UIControlStateSelected];
    ...
    [speedBtn3 setTitleColor:SZPLAYER_TintColor forState:UIControlStateSelected];
    ...
    [speedBtn4 setTitleColor:SZPLAYER_TintColor forState:UIControlStateSelected];
    ...
    [speedBtn5 setTitleColor:SZPLAYER_TintColor forState:UIControlStateSelected];
    ...
    [speedBtn6 setTitleColor:SZPLAYER_TintColor forState:UIControlStateSelected];
