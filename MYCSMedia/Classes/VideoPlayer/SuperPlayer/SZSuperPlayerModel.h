...
extern NSNotificationName sz_kSuperPlayerModelReady;
extern NSNotificationName sz_kSuperPlayerModelFail;

/** 多码率地址 */
@interface SZSuperPlayerUrl : NSObject
 ...
 */
@interface SZSuperPlayerVideoId : NSObject
/**
 * appId
 */
...
@interface SZSuperPlayerModel : NSObject
 ...
 * 腾讯云存储对象
 */
@property SZSuperPlayerVideoId *videoId;
 ...
 * 多码率视频URL
 */
@property (nonatomic, strong) NSArray<SZSuperPlayerUrl *> *multiVideoURLs;
