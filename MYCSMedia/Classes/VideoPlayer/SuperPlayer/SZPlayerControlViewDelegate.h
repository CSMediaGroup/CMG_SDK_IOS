#ifndef SZPlayerControlViewDelegate_h
#define SZPlayerControlViewDelegate_h


@class SZSuperPlayerUrl;
@class SZSuperPlayerControlView;

@protocol SZPlayerControlViewDelegate <NSObject>
...
/** 修改配置 */
- (void)controlViewDidUpdateConfig:(SZSuperPlayerControlView *)controlView withReload:(BOOL)reload;
/** 重新播放 */
