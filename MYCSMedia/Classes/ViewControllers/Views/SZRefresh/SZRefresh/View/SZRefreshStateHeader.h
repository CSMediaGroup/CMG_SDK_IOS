...
#if __has_include(<SZRefresh/SZRefreshHeader.h>)
#import <SZRefresh/SZRefreshHeader.h>
#else
...
@interface SZRefreshStateHeader : SZRefreshHeader
#pragma mark - 刷新时间相关
...
@interface SZRefreshStateHeader (ChainingGrammar)
