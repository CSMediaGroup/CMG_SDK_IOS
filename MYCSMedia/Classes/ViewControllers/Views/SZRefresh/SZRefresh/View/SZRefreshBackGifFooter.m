...
@interface SZRefreshBackGifFooter()
{
...
@implementation SZRefreshBackGifFooter
#pragma mark - 懒加载
- (UIImageView *)gifView
{
    if (!_gifView) {
...
- (void)placeSubviews
{
    ...
    if (self.stateLabel.hidden) {
        ...
        self.gifView.sz_w = self.sz_w * 0.5 - self.labelLeftInset - self.stateLabel.sz_textWidth * 0.5;
    }
}
