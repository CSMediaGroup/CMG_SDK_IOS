...
{
    SZCommentModel * commentM = dataModel.dataArr[indexPath.section];
    SZReplyModel * replyM = commentM.dataArr[indexPath.row];
...
{
    __weak typeof (self) weakSelf = self;
    [SZInputView callInputView:TypeSendComment contentId:[SZData sharedSZData].currentContentId replyId:nil placeHolder:@"发表您的评论" completion:^(id responseObject) {
