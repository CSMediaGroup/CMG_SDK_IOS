...
-(void)replyBtnAction
{
    [SZInputView callInputView:TypeSendReply contentId:[SZData sharedSZData].currentContentId replyId:dataModel.id placeHolder:[NSString stringWithFormat:@"回复@%@",dataModel.nickname] completion:^(id responseObject) {
    }];
