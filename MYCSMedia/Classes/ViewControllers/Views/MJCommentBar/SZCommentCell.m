...
-(void)setCommentData:(SZCommentModel*)commentM replyData:(SZReplyModel*)replyM
{
    dataModel = replyM;
...
-(void)replyBtnAction
{
    [SZInputView callInputView:TypeSendMail contentId:[SZData sharedSZData].currentContentId replyId:dataModel.id placeHolder:[NSString stringWithFormat:@"回复@%@",dataModel.nickname] completion:^(id responseObject) {
