...
+(void)callInputView:(SZInputViewType)type SZContentModel:(SZContentModel*)contentM replyId:(NSString*)replyId placeHolder:(NSString*)placeholder completion:(CompletionBlock)finish;
